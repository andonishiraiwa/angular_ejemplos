...
/**
 * Al relizar click sobre el boton, tenemos que emitir un evento para avisar al padre usando el nombre del @Output llamarPadre: EventEmitter
 * @param event
 * 
 */
...
//llamarPadre => @Output hay que usar la funcoin "EMIT"
